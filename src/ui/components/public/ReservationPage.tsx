    ...
    try {
      ...
      (async () => {
        ...
        try {
          ...
          const bookingTime = `${bookingTimeFrom}${
            bookingTimeTo ? ' – ' + bookingTimeTo : ''
          }`;
          ...
          const detailsHtml = `
            ...
            <ul style="list-style:none;padding:0;margin:0;font-size:14px;line-height:1.5;">
              ...
              <li><strong>Időpont:</strong> ${adminPayload.bookingTime}</li>
