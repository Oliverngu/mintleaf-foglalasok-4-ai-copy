...
const AppManager: React.FC<{ unitId: string; disabledApps: string[]; allUnits: Unit[] }> = ({
    unitId,
    disabledApps,
    allUnits,
}) => {
    ...
    const handleSave = async () => {
        ...
        try {
            await setDoc(
                ...
                { disabledApps: localDisabledApps },
                { merge: true }
            );
    ...
    return (
        <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
            ...
            <p className="text-gray-600 mt-1 mb-4">
                Válaszd ki, mely alkalmazások legyenek elérhetőek{' '}
                <span className="font-semibold">{unitName}</span> felhasználói számára. A
                letiltott alkalmazások nem jelennek meg a menüben.
            </p>
            ...
            return (
                <div className="p-8 text-center bg-white rounded-2xl shadow-md border">
                    ...
                    <p className="mt-2 text-gray-600">
                        Ennek a funkciónak a használatához válassz ki pontosan egy egységet a fejlécben.
                    </p>
                </div>
            );
        }
        ...
        switch (activeTab) {
            case 'felhasznalok':
                return (
                    <FelhasznalokApp
                        ...
                        canGenerateInvites={props.canGenerateInvites}
                    />
                );
            case 'meghivok':
                return <MeghivokApp />;
            ...
            case 'alkalmazasok':
                return (
                    <AppManager
                        unitId={activeUnitId!}
                        disabledApps={unitPermissions[activeUnitId!]?.disabledApps || []}
                        allUnits={allUnits}
                    />
                );
            case 'notifications':
