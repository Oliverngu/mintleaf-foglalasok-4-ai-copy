...
const ReservationSettingsForm: FC<ReservationSettingsFormProps> = ({ unitId, currentUser, onClose, layout = 'modal' }) => {
    ...
    const containerClasses = layout === 'modal'
        ? 'bg-white rounded-2xl shadow-xl w-full max-w-5xl h-[90vh] flex flex-col'
        : 'bg-white rounded-2xl shadow-sm border w-full flex flex-col';
